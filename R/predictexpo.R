...
#' @param new.data `data.frame` con los valores de los predictores en los puntos de prediccion. El nombre de las variables debe ser igual al usado en el ajuste del modelo.
#' @param level Un valor en (0,1) para el nivel de confianza de los intervalos. Por defecto es 0.95.
#' @param interval Una cadena de caracteres correspondiendo a uno de los siguientes casos: `"none"`, `"confidence"`, `"prediction"`. Por defecto es `"none"`, es decir, calcula solo estimaciones o pronosticos puntuales. Para intervalos de confianza en la respuesta media use `"confidence"` y para intervalos de prediccion use `"prediction"`.
#'
