...
#' * `p` El total de parámetros aproximados en el ajuste de tedencia y estacionalidad.
...
#' * `fitted` Objeto `ts` de la serie estimada combinando aditiva o multiplicativamente, según el tipo de descomposición, las estimaciones de la tendencia y e la estacionalidad.
