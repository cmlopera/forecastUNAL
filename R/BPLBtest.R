...
#' @param maxlag Entero indicando el maximo orden de rezago temporal hasta el cual se prueba la significancia de la funcion de autocorrelacion.
...
#' * `Xsquared` los valores de los estadisticos de prueba para `m=6, 12,...,[maxlag/6]`.
#' * `df` los grados de libertad del estadistico de prueba, corresponden a los valores de `m=6, 12,...,[maxlag/6]`.
