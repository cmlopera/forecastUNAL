...
#' @param min.n Un escalar para indicar el mínimo tamaño de muestra con el que debe iniciar la estimación recursiva, el cual no puede ser inferior `ncol(dataX) + 2`.
