...
#' @param tiempo Vector de valores enteros positivos con el indice de tiempo para los cuales se debe calcular las funciones trigonométricas. 
...
#' @export
#' @examples
#' t <- 1:20 #indice de tiempo primeros 20 valores
